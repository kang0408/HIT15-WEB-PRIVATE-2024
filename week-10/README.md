...
Lấy đầu vào từ người dùng bằng `prompt("Nhập tháng của bạn: ")`. Viết một chương trình xác định số ngày trong tháng đó và hiển thị kết quả bằng `alert`. Lưu ý tháng 2 năm nhuận và không nhuận
